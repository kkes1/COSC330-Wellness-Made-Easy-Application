...
public class TakePartsBody extends AppCompatActivity {

    private TextView head, shoulder, chest, stomach, arm, hand, feet, error;
    private TextView headinput, shoulderinput, chestinput, stomachinput, arminput, handinput, feetinput;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_takeparts_body);
        ...
        feet = findViewById(R.id.FeetBox);
        ...
        feetinput.setOnTouchListener(new ChoiceTouchListener());
        ...
        feet.setOnDragListener(new ChoiceDragListener());
            ...
            new View.OnClickListener() {
                ...
                public void onClick(View btn) {
                    ...
                    if (flag == true){ // if all the answers are correct
                        ...
                        Intent intent = new Intent(getApplicationContext(), TakePartsHead.class); // move on to the next exercise
    ...
    private final View.OnClickListener resetBank = // resets word bank and answer boxes
            new View.OnClickListener() {
                ...
                public void onClick(View btn) {
                    ...
                    feetinput.setVisibility(TextView.VISIBLE);
                    ...
                    feet.setTypeface(Typeface.DEFAULT);

                    arm.setOnDragListener(new TakePartsBody.ChoiceDragListener());
                    shoulder.setOnDragListener(new TakePartsBody.ChoiceDragListener());
                    chest.setOnDragListener(new TakePartsBody.ChoiceDragListener());
                    stomach.setOnDragListener(new TakePartsBody.ChoiceDragListener());
                    arm.setOnDragListener(new TakePartsBody.ChoiceDragListener());
                    hand.setOnDragListener(new TakePartsBody.ChoiceDragListener());
                    feet.setOnDragListener(new TakePartsBody.ChoiceDragListener());
                }
            };
}
