...
public class MariaAnswers extends AppCompatActivity {

    private TextView answer1, answer2, answer3, answer4; // TextViews that hold the user's answers
    private TextView feedbackOne, feedbackTwo, feedbackThree, feedbackFour; // TextViews that display if a user's answer is right/wrong
    ...
    private static final String[] qFourAnswers = { // holds correct answers to question 3
            "speaks",
            "speak",
            "not",
            "spanish",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maria_answers);
    ...
    private final View.OnClickListener retakeQuiz = // sends user back to quiz
            new View.OnClickListener() {
                @Override
                public void onClick(View btn) {
                    Intent intent = new Intent(getApplicationContext(), MariaQuestions.class);
                    startActivity(intent);
                }
            };
    ...
    public void checkAnswer(String str, int questionNumber){
        ...
        switch (questionNumber) { // this loads the correct answer tokens for the respective question's answer
            ...
            case 3:
                ...
                break;
            case 4:
                arr = qFourAnswers; // load question 4's answers
                arrLen = 7;
                flag = isCorrect(tokens, arr, arrLen);
                if (flag == true) {
